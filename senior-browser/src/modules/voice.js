...
// Encapsulating everything into one function
export const processPage = () => {
    ...
    const blurNegnews = () => {
        const allNewstext = document.querySelectorAll(".n0jPhd.ynAwRc.MBeuO.nDgy9d, .GI74Re.nDgy9d, .iHxmLe, .KYaZsb, .n0jPhd.ynAwRc.tNxQIb.nDgy9d, .SoAPf");
    ...
    // Apply the necessary styles and content changes on page load
